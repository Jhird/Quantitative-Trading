...
Location = os.getcwd()
orders_file = 'TS_optimized_bollinger_SP500_orders.csv'#str(sys.argv[2])
...
# Initialize Cash
init_cash = 100000.0#float(str(sys.argv[1]))
c = init_cash
...
os.chdir(location)
filename = 'TS_optimized_bollinger_SP500_values.csv'#str(sys.argv[3])
f = open(filename,'w')
for i in range(len(ldt_timestamps)):
